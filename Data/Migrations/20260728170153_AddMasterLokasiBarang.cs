...
{
    /// <inheritdoc />
    public partial class AddMasterLokasiBarang : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "MasterBarang",
                columns: new[] { "IdBarang", "Icon", "Kategori", "NamaBarang" },
                values: new object[,]
                {
                    { 1, "📹", "Video", "Proyektor" },
                    { 2, "🖥️", "Video", "Layar Proyektor" },
                    { 3, "🔊", "Audio", "Sound System" },
                    { 4, "🎤", "Audio", "Mic Wireless" },
                    { 5, "🎤", "Audio", "Mic Kabel" },
                    { 6, "💻", "Komputer", "Laptop" },
                    { 7, "🔌", "Kelistrikan", "Kabel Roll" },
                    { 8, "🔌", "Kelistrikan", "Kabel HDMI" },
                    { 9, "📍", "Aksesoris", "Pointer Presentasi" },
                    { 10, "📷", "Video", "Webcam" },
                    { 11, "🎛️", "Audio", "Mixer Audio" },
                    { 12, "📺", "Video", "Videotron / LED Wall" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ruang rapat utama lantai 1", "Gedung Rektorat Lt. 1" },
                    { 2, "Ruang rapat lantai 2", "Gedung Rektorat Lt. 2" },
                    { 3, "Aula besar untuk acara resmi", "Gedung Rektorat Lt. 3 - Aula Utama" },
                    { 4, "Auditorium utama kampus", "Auditorium BJ Habibie" },
                    { 5, "Ruang serbaguna untuk seminar dan workshop", "Ruang Serbaguna Gedung B" },
                    { 6, "Lab komputer untuk pelatihan", "Lab Komputer Gedung C" },
                    { 7, "Area outdoor untuk event besar", "Lapangan Utama" }
                });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 3, new DateTime(2026, 7, 29, 0, 0, 0, 0, DateTimeKind.Local) });
