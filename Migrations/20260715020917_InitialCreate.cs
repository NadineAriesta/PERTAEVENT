    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "AQAAAAIAAYagAAAAEJDT0rZjeX4iYZbcxfnOSm+0ZLRm9AAYcX3lA9NBGivHNmgsocCm2gW/7FdZzWOKHQ==", true, "admin" },
                    { 2, "AQAAAAIAAYagAAAAEDX0xHgxohZ66SG1Jr9NLjBOSgjDZd+5kUlyxOj+bo/yi4aBSV/Dl45EJvcZWuD6/Q==", true, "helpdesk" },
                    { 3, "AQAAAAIAAYagAAAAELwPksv6pqXjqAyoKlinmUU/DmacRDvwr45RRXmZa4doSEMBNmZQLZMpB4FqqvzBww==", true, "pak_joko" },
                    { 4, "AQAAAAIAAYagAAAAEOvh6HIM4Shn/g0fgiVL/ITEh97QqAFqdo5r2sF36D5R3o+np9fjjJfsJEpplRHc/Q==", true, "pak_budi" },
                    { 5, "AQAAAAIAAYagAAAAEPtI89FhxJ8QL0MjmVS+Li01zXxXuiUmECE9gYslGTRn8CWyRfP/LqpVTGeANz75oQ==", true, "pak_bambang" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, new TimeSpan(0, 9, 0, 0, 0), new TimeSpan(0, 12, 0, 0, 0), "Aula Utama Gedung Rektorat Lt. 3", "Rapat Pleno Senat Universitas", "Belum Ditugaskan", new DateTime(2026, 7, 15, 0, 0, 0, 0, DateTimeKind.Local) },
                    { 2, 2, new TimeSpan(0, 13, 0, 0, 0), new TimeSpan(0, 16, 30, 0, 0), "Auditorium BJ Habibie", "Seminar Nasional IT & AI", "Belum Ditugaskan", new DateTime(2026, 7, 16, 0, 0, 0, 0, DateTimeKind.Local) }
                });
