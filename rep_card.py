                                            ...
                                            <div class="col-md-5">
                                                <div style="background: transparent;">
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <button class="btn flex-fill" style="background-color: #0f172a; color: white; font-size: 0.8rem; border-radius: 8px;" @onclick="async () => await OpenUploadModalAdmin(assign)">
...
pattern = re.compile(r'var statusLabel = assign\.StatusPenugasan;\s*<div class="col-12">.*?</div>\s*</div>\s*</div>\s*</div>\s*</div>\s*</div>\s*</div>', re.DOTALL)
def rep_func(m):
    return 'var statusLabel = assign.StatusPenugasan;\n                            ' + code

modified, count = pattern.subn(rep_func, text)

print("Replaced instances:", count)
